public function getPosts()
	...
	public function getReplies()
	{
            ...
            var_dump($data);
                ...
                $id=implode(',',array_map('intval',$data));
            
            
            var_dump($id);
		$sql="SELECT r.*,u.*,d.* from tbl_replies as r
                LEFT JOIN user as u ON r.user_id=u.user_id 
                LEFT JOIN tbl_discussion as d ON r.discussion_id = d.discussion_id where r.discussion_id in (".$id.")";
...
<?php echo empty($post->discussion_id)?"":""?>
